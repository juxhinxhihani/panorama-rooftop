...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Menu Items - Desserts
    menuZupa: 'Zupa',
    menuZupaDesc: 'Traditional layered dessert with custard and sponge cake',
    menuCheesecake: 'Cheesecake',
    menuCheesecakeDesc: 'Rich and creamy cheesecake with fresh berry topping',
    menuTrilece: 'Trilece',
    menuTrileceDesc: 'Traditional three milk cake - Albanian specialty dessert',
    menuTiramisu: 'Tiramisu',
    menuTiramisuDesc: 'Classic Italian coffee-flavored dessert with mascarpone cheese',
    menuTrigone: 'Trigone',
    menuTrigoneDesc: 'Traditional triangular pastry filled with sweet cream',
    menuMyfile: 'Mille-feuille',
    menuMyfileDesc: 'Delicate layered puff pastry with vanilla cream filling',
    menuPastashu: 'Cream Puff',
    menuPastashuDesc: 'Light and airy choux pastry filled with fresh whipped cream',
    menuBrioshChocolate: 'Chocolate Brioche',
    menuBrioshChocolateDesc: 'Rich and buttery brioche pastry with chocolate filling',
    menuBrioshPistachio: 'Pistachio Brioche',
    menuBrioshPistachioDesc: 'Delicate brioche pastry with creamy pistachio filling',
    menuDonut: 'Donut',
    menuDonutDesc: 'Freshly made glazed donut with sweet sugar coating',
    menuBigusto: 'Bigusto',
    menuBigustoDesc: 'Double flavor pastry with two delicious cream fillings',
    
    // Menu Items - Cocktails
    menuNegroni: 'Negroni',
    menuNegroniDesc: 'Classic Italian aperitif with gin, sweet vermouth, and Campari',
    menuMartini: 'Martini',
    menuMartiniDesc: 'Elegant and sophisticated cocktail with gin and dry vermouth',
    menuMojito: 'Mojito',
    menuMojitoDesc: 'Refreshing Cuban cocktail with white rum, fresh mint, and lime',
    menuAperolSpritz: 'Aperol Spritz',
    menuAperolSpritzDesc: 'Light Italian aperitif with Aperol, prosecco, and sparkling water',
    menuVodkaSour: 'Vodka Sour',
    menuVodkaSourDesc: 'Smooth and tangy vodka cocktail with fresh lemon juice',
    menuSexOnTheBeach: 'Sex on the Beach',
    menuSexOnTheBeachDesc: 'Tropical fruity cocktail with vodka, peach schnapps, and fruit juices',
    menuTequilaSunrise: 'Tequila Sunrise',
    menuTequilaSunriseDesc: 'Beautiful layered cocktail with tequila, orange juice, and grenadine syrup',
    menuPinaColada: 'Pina Colada',
    menuPinaColadaDesc: 'Creamy tropical cocktail with white rum, coconut cream, and pineapple',
    menuGinTonic: 'Gin & Tonic',
    menuGinTonicDesc: 'Classic refreshing cocktail with premium gin and tonic water',
    menuCaipiroska: 'Caipiroska',
    menuCaipiroskaDesc: 'Brazilian-inspired cocktail with vodka, muddled lime, and sugar',
    menuCosmopolitan: 'Cosmopolitan',
    menuCosmopolitanDesc: 'Sophisticated pink cocktail with vodka, cranberry, and lime juice',
    menuAnalcolic: 'Virgin Cocktail',
    menuAnalcolicDesc: 'Refreshing non-alcoholic cocktail with fresh fruits and aromatic herbs',
    menuPanorama: 'Panorama Special',
    menuPanoramaDesc: 'Our signature house cocktail with a secret blend of premium spirits',
    menuAMF: 'AMF',
    menuAMFDesc: 'Powerful cocktail with multiple premium spirits - for experienced drinkers',
    menuGinLemon: 'Gin Lemon',
    menuGinLemonDesc: 'Simple and refreshing cocktail with premium gin and fresh lemon',
    menuCubaLibre: 'Cuba Libre',
    menuCubaLibreDesc: 'Classic Cuban cocktail with white rum, cola, and fresh lime wedge',
    menuMargarita: 'Margarita',
    menuMargaritaDesc: 'Classic Mexican cocktail with tequila, fresh lime juice, and triple sec',
    
    // Menu Items - Coffee
    menuEkspres: 'Espresso',
    menuEkspresDesc: 'Rich and intense espresso shot from premium Italian coffee beans',
    menuMacchiato: 'Macchiato',
    menuMacchiatoDesc: 'Traditional espresso "marked" with a dollop of steamed milk foam',
    menuMacchiatoLarge: 'Large Macchiato',
    menuMacchiatoLargeDesc: 'Double espresso shot macchiato with extra steamed milk foam',
    menuCappuccino: 'Cappuccino',
    menuCappuccinoDesc: 'Perfect Italian balance of espresso, steamed milk, and velvety foam',
    menuCappuccinoKafe: 'Coffee Cappuccino',
    menuCappuccinoKafeDesc: 'Strong cappuccino with extra espresso shot for intense coffee flavor',
    menuFreddoCappuccino: 'Freddo Cappuccino',
    menuFreddoCappuccinoDesc: 'Refreshing iced cappuccino with cold milk foam, perfect for summer',
    menuChocolateCold: 'Cold Chocolate',
    menuChocolateColdDesc: 'Rich and refreshing cold chocolate drink topped with whipped cream',
    menuChocolateBlack: 'Dark Chocolate',
    menuChocolateBlackDesc: 'Rich and decadent hot dark chocolate with intense cocoa flavor',
    menuChocolateWhite: 'White Chocolate',
    menuChocolateWhiteDesc: 'Creamy and smooth white chocolate drink with delicate sweet taste',
    menuMilkshake: 'Milkshake',
    menuMilkshakeDesc: 'Thick and creamy milkshake made with premium ice cream, various flavors',
    menuFrappe: 'Frappe',
    menuFrappeDesc: 'Greek-style iced coffee drink blended with ice, milk, and foam',
    menuFreddoKafe: 'Freddo Coffee',
    menuFreddoKafeDesc: 'Greek-style cold espresso drink served over ice with foam',
    menuFredoccino: 'Fredoccino',
    menuFredoccinoDesc: 'Refreshing cold coffee drink with chocolate syrup and milk foam',
    menuKafeKremoso: 'Creamy Coffee',
    menuKafeKremosoDesc: 'Smooth and velvety coffee with rich creamy texture and foam',
    menuKafeLatte: 'Cafe Latte',
    menuKafeLatteDesc: 'Classic espresso with steamed milk and a light layer of foam',
    menuKakao: 'Hot Cocoa',
    menuKakaoDesc: 'Traditional hot cocoa made with real chocolate and steamed milk',
    menuHotTea: 'Hot Tea',
    menuHotTeaDesc: 'Premium selection of hot teas - black, green, herbal, and fruit varieties',
    menuKakaoCold: 'Cold Cocoa',
    menuKakaoColdDesc: 'Refreshing iced cocoa drink with whipped cream, perfect for warm days',
  ...
  sq: {
    ...
    menuTropicalBliss: 'Tropical Bliss',
    menuTropicalBlissDesc: 'Ananas, mango, banane, qumësht bajameje, mjalte',
    menuAntioxidantPower: 'Antioxidant Power',
    menuAntioxidantPowerDesc: 'Boronica, mjedër, banane, qumësht bajameje, fara chia',
    menuPeanutPower: 'Peanut Power',
    menuPeanutPowerDesc: 'Banane, gjalpë kikiriku, kakao, qumësht bajameje',
    menuBlueberryBananaCrunch: 'Blueberry Banana Crunch',
    menuBlueberryBananaCrunchDesc: 'Boronica, banane, kos i bardhë, biskota të thërrmuara',
    menuGreenReset: 'Green Reset',
    menuGreenResetDesc: 'Selino, ananas, kastravec, limon',
    menuPureOrange: 'Pure Orange',
    menuPureOrangeDesc: 'Portokall i freskët i shtrydhur',
    menuSunriseMix: 'Sunrise Mix',
