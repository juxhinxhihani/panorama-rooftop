...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    menuAnalcolic: 'Non-Alcoholic Cocktail',
    ...
    menuOrangeJuice: 'Orange Juice',
    menuOrangeJuiceMedium: 'Orange Juice (Medium)',
    menuLifeJuice: 'Life Juice',
    menuDetoxJuice: 'Detox Juice',
    menuProteinSmoothie: 'Protein Smoothie',
    menuPineappleSmoothie: 'Pineapple Smoothie',
    menuBananaSmoothie: 'Banana Smoothie',
