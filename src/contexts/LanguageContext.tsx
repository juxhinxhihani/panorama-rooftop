...
const translations: Record<Language, Record<string, string>> = {
  ...
  it: {
    ...
    menuEkspres: 'Espresso',
    menuEkspresDesc: 'Espresso ricco e corposo da chicchi di caffè premium',
    menuMacchiato: 'Macchiato',
    menuMacchiatoDesc: 'Espresso "macchiato" con una goccia di schiuma di latte',
    menuMacchiatoLarge: 'Macchiato Grande',
    menuMacchiatoLargeDesc: 'Macchiato doppio con schiuma di latte extra',
    menuCappuccino: 'Cappuccino',
    menuCappuccinoDesc: 'Perfetto equilibrio di espresso, latte montato e schiuma',
    menuCappuccinoKafe: 'Cappuccino Caffè',
    menuCappuccinoKafeDesc: 'Cappuccino forte con sapore di caffè extra e intensità',
    menuFreddoCappuccino: 'Cappuccino Freddo',
    menuFreddoCappuccinoDesc: 'Cappuccino freddo con ghiaccio, perfetto per il caldo',
    menuChocolateCold: 'Cioccolata Fredda',
    menuChocolateColdDesc: 'Bevanda al cioccolato fredda rinfrescante con panna',
    menuChocolateBlack: 'Cioccolata Fondente',
    menuChocolateBlackDesc: 'Cioccolata calda ricca con intenso sapore di cacao',
    menuChocolateWhite: 'Cioccolata Bianca',
    menuChocolateWhiteDesc: 'Cioccolata bianca cremosa dal gusto dolce e morbido',
    menuMilkshake: 'Frappè',
    menuMilkshakeDesc: 'Frappè denso e cremoso disponibile in vari gusti',
    menuFrappe: 'Frappè',
    menuFrappeDesc: 'Bevanda al caffè ghiacciato frullato con ghiaccio e latte',
    menuFreddoKafe: 'Caffè Freddo',
    menuFreddoKafeDesc: 'Bevanda al caffè freddo a base espresso servita su ghiaccio',
    menuFredoccino: 'Fredoccino',
    menuFredoccinoDesc: 'Bevanda al caffè freddo con cioccolato e schiuma di latte',
    menuKafeKremoso: 'Caffè Cremoso',
    menuKafeKremosoDesc: 'Caffè morbido e cremoso con texture ricca',
    menuKafeLatte: 'Caffè Latte',
    menuKafeLatteDesc: 'Espresso con latte montato e strato di schiuma leggera',
    menuKakao: 'Cacao',
    menuKakaoDesc: 'Cacao caldo tradizionale con ricco sapore di cioccolato',
    menuHotTea: 'Tè Caldo',
    menuHotTeaDesc: 'Selezione di tè premium - nero, verde ed erboristico',
    menuKakaoCold: 'Cacao Freddo',
    menuKakaoColdDesc: 'Cacao freddo rinfrescante perfetto per ogni stagione',
    menuFrappeOreo: 'Frappè Oreo',
    menuFrappeOreoDesc: 'Delizioso frappè frullato con biscotti Oreo e panna',
