...
const translations: Record<Language, Record<string, string>> = {
  ...
  sq: {
    ...
    menuEkspres: 'Ekspres',
    menuEkspresDesc: 'Kafe e fortë dhe e pasur nga kokrra kafeje premium',
    menuMacchiato: 'Macchiato',
    menuMacchiatoDesc: 'Ekspres i "shënuar" me një pikë shkume qumështi',
    menuMacchiatoLarge: 'Macchiato e Madhe',
    menuMacchiatoLargeDesc: 'Macchiato me dy shot ekspres dhe shkumë ekstra',
    menuCappuccino: 'Cappuccino',
    menuCappuccinoDesc: 'Ekuilibër i përsosur i ekspres, qumësht dhe shkumë',
    menuCappuccinoKafe: 'Cappuccino Kafe',
    menuCappuccinoKafeDesc: 'Cappuccino i fortë me shije ekstra kafeje',
    menuFreddoCappuccino: 'Freddo Cappuccino',
    menuFreddoCappuccinoDesc: 'Cappuccino i ftohtë me akull, i përsosur për mot të ngrohtë',
    menuChocolateCold: 'Çokollatë e Ftohtë',
    menuChocolateColdDesc: 'Pije çokollate freskuese e ftohtë me krem',
    menuChocolateBlack: 'Çokollatë e Zezë',
    menuChocolateBlackDesc: 'Çokollatë e ngrohtë e pasur me shije intensive kakao',
    menuChocolateWhite: 'Çokollatë e Bardhë',
    menuChocolateWhiteDesc: 'Çokollatë e bardhë kremoz me shije të ëmbël',
    menuMilkshake: 'Milkshake',
    menuMilkshakeDesc: 'Milkshake i trashë dhe kremoz në aroma të ndryshme',
    menuFrappe: 'Frappe',
    menuFrappeDesc: 'Kafe e ftohtë e përzier me akull dhe qumësht',
    menuFreddoKafe: 'Freddo Kafe',
    menuFreddoKafeDesc: 'Pije kafeje e ftohtë me bazë ekspres mbi akull',
    menuFredoccino: 'Fredoccino',
    menuFredoccinoDesc: 'Kafe e ftohtë me çokollatë dhe shkumë qumështi',
    menuKafeKremoso: 'Kafe Kremoso',
    menuKafeKremosoDesc: 'Kafe e butë dhe kremoz me teksturë të pasur',
    menuKafeLatte: 'Kafe Latte',
    menuKafeLatteDesc: 'Ekspres me qumësht të avulluar dhe shkumë të lehtë',
    menuKakao: 'Kakao',
    menuKakaoDesc: 'Kakao tradicionale e ngrohtë me shije të pasur çokollate',
    menuHotTea: 'Çaj i Ngrohtë',
    menuHotTeaDesc: 'Përzgjedhje çajesh premium - të zi, të gjelbër dhe bimore',
    menuKakaoCold: 'Kakao e Ftohtë',
    menuKakaoColdDesc: 'Kakao freskuese e ftohtë e përsosur për çdo stinë',
    menuFrappeOreo: 'Frappe Oreo',
    menuFrappeOreoDesc: 'Frappe e shijshme e përzier me biskota Oreo dhe krem',
